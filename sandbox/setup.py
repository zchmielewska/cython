...
# setup(name="cy_calculate3", ext_modules=cythonize("cy_calculate3.pyx", compiler_directives={"language_level": "3"}))
setup(name="cy_calculate4", ext_modules=cythonize("cy_calculate4.pyx", compiler_directives={"language_level": "3"}))
